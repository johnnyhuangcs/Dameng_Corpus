...
![遍历字符串](https://download.dameng.com/eco/docs/asset/sql-dev/string-1.png)
...
![字符串中增加引号](https://download.dameng.com/eco/docs/asset/sql-dev/string-2.png)
...
![删除不需要字符](https://download.dameng.com/eco/docs/asset/sql-dev/string-3.png)
...
![字符与数字分离](https://download.dameng.com/eco/docs/asset/sql-dev/string-4.png)
...
![创建分割列表](https://download.dameng.com/eco/docs/asset/sql-dev/string-5.png)
...
![分解 ip 地址](https://download.dameng.com/eco/docs/asset/sql-dev/string-6.png)
